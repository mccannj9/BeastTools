...
class Node:
    ...
    def getNewick(self, seenHybrids):
        ...
        if len(self.annotation) > 0:
            thisStr += "[&" + ",".join(map(lambda k: k[0] + "=" + k[1], list(self.annotation.items()))) + "]"
...
class Graph:
    ...
    def __repr__(self):
        return "Phylogenetic tree with {} nodes (including {} leaves).".format(
            len(self.getNodeList()), len(self.getLeafList())
        )
